...
\begin{minipage}[b]{0.5\textwidth}
	\begin{itemize}
			...
			\item {\textbf{Thirsty Crow:}
				\begin{itemize}
				  	\item {\footnotesize Bot traverses arena using line follower and pick-drop the magnetic objects with the help of mechanism.
			...
			\item {\textbf{Huffman code for Compression and Decompression:}
						\begin{itemize}
						  	\item {\footnotesize Compresses and decompresses the text file using basics of Data structures.
			...
			\begin{LARGE}
				...
				{\small
					\begin{enumerate}
						...
						\item \textbf{Finalist}in Mindspark'18 \textbf{Hackathon 3.0} .\linebreak
						\item \textbf{Distinction in Visharad Pratham},in Indian Classical Singing by Akhil Bhartiy Gandharv Mahavidyalay(2015).\linebreak
						\item \textbf{2nd Runner-up}in State level singigng Competition MIC-DROP at BMCC, Pune.\linebreak
						\item \textbf{1st rank} in SSC Kolhaput Board with \textbf{98.80\%}.\linebreak
			...
			\begin{LARGE}
				...
				{\small
					\begin{itemize}
						...
						\item {Katalyst Training for self awareness, self conceptsand values, etc.}
